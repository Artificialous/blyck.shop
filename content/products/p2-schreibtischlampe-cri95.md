...
images:
  - zoom: 100
    ...
    moveY: 0
    aiBadge: false
    src: assets/uploads/xiaomi-mi-smart-led_img1.jpg
  - zoom: 100
    moveX: 0
    moveY: 0
    aiBadge: true
...
shortDesc: Ra 90 und stufenlose Dimmung ab 1 % — der Punkt, an dem günstige
  Lampen sonst in Stufen springen.
baseClicks: 962
price: 52,36
oldPrice: ""
...
lead: "Zwei Dinge trennen eine brauchbare Schreibtischlampe von einer billigen:
  ...
  Dimmen anfängt zu flackern. Diese tut beides richtig — 1 bis 100 Prozent ohne
  Raster, und laut Hersteller ohne sichtbares Flimmern auch in den unteren
  Stufen. Dazu ein Farbtemperaturbereich von 2600 bis 5000 Kelvin, also von
  abendlichem Warmweiß bis zu neutralem Arbeitslicht. Vier voreingestellte
  Lichtprofile — Fokus, Lesen, PC-Arbeit und ein gedimmter Kindermodus — lassen
  sich direkt am Drehknopf abrufen, ohne die App öffnen zu müssen. Für den Preis
  ist das eine ungewöhnlich vollständige Ausstattung."
pros:
  - Farbwiedergabe Ra 90 mit unabhängigem Prüfbericht — bei Lampen dieser
    Preisklasse selten belegt
  - Stufenlos dimmbar von 1 bis 100 %, kein Rasten in feste Stufen
  - Farbtemperatur 2600–5000 K frei wählbar, deckt Abendlicht bis neutrales
    Arbeitslicht ab
  - Bedienung direkt am Drehknopf, App ist optional und nicht Voraussetzung
  - Vier Lichtprofile (Fokus, Lesen, PC, Kindermodus) direkt per Drehknopf
    abrufbar, ohne App
cons:
  - Ra 90 reicht für Bildschirmarbeit und Lesen, nicht für farbverbindliche
    Beurteilung von Druckmustern — dafür braucht es Ra 95 oder höher
  - 30 bis 520 Lumen sind für einen Arbeitsplatz ausreichend, aber kein Ersatz
